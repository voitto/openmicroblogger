...
if (!class_exists('MIME4')) require_once library_path().'xpertmailer'.DIRECTORY_SEPARATOR . 'MIME4.php';
...
class SMTP4 {
  ...
  function mxconnect($host = null, $port = null, $tout = null, $name = null, $context = null, $debug = null) {
    ...
    if ($res) {
      foreach ($arr as $mx) {
        if ($con = SMTP4::connect($mx, $port, null, null, null, $tout, $name, $context, $debug)) break;
      }
    }
    if (!$con) $con = SMTP4::connect($host, $port, null, null, null, $tout, $name, $context, $debug);
    return $con;
  }
