...
if (!class_exists('SMTP4')) require_once library_path().'xpertmailer'.DIRECTORY_SEPARATOR . 'SMTP4.php';
...
class MAIL4 {
  ...
  function connect($host = null, $port = null, $user = null, $pass = null, $vssl = null, $tout = null, $name = null, $context = null, $debug = null) {
    ...
    if ($ret = SMTP4::connect($host, $port, $user, $pass, $vssl, $tout, $name, $context, $debug)) $this->_conns[] = $ret;
