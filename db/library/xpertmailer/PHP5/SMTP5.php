...
if (!class_exists('MIME5')) require_once library_path().'xpertmailer'.DIRECTORY_SEPARATOR . 'MIME5.php';
...
class SMTP5 {
  ...
  static public function mxconnect($host = null, $port = null, $tout = null, $name = null, $context = null, $debug = null) {
    ...
    if ($res) {
      foreach ($arr as $mx) {
        if ($con = self::connect($mx, $port, null, null, null, $tout, $name, $context, $debug)) break;
      }
    }
    if (!$con) $con = self::connect($host, $port, null, null, null, $tout, $name, $context, $debug);
    return $con;
  }

  static public function connect($host = null, $port = null, $user = null, $pass = null, $vssl = null, $tout = null, $name = null, $context = null, $debug = null) {
    if (!FUNC5::is_debug($debug)) $debug = debug_backtrace();
    global $_RESULT;
    $_RESULT = $err = array();
