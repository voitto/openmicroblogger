...
if (!class_exists('SMTP5')) require_once library_path().'xpertmailer'.DIRECTORY_SEPARATOR . 'SMTP5.php';
...
class MAIL5 {
  ...
  public function connect($host = null, $port = null, $user = null, $pass = null, $vssl = null, $tout = null, $name = null, $context = null, $debug = null) {
    global $_RESULT;
    $_RESULT = array();
    if (!FUNC5::is_debug($debug)) $debug = debug_backtrace();
    ...
    if ($ret = SMTP5::connect($host, $port, $user, $pass, $vssl, $tout, $name, $context, $debug)) $this->_conns[] = $ret;
