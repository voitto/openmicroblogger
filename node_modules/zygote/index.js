...
Model.prototype.create = function( data ) {
  ...
  var ins_query = client.query({
    text: 'INSERT INTO post (title,body,updated,published,author,author_url) VALUES ($1,$2,$3,$4,$5,$6)',
    values: [data.title,"","",dt,data.author,data.author_url]
  });
...
Model.prototype.find = function(id) {
  ...
  var query = client.query({
    text: 'CREATE TABLE post (title text, body text, updated varchar(255), published varchar(255), author varchar(255), author_url varchar(255), id serial)',
    values: []
  });
  ...
  jsdom.env({
    ...
    scripts: ["http://code.jquery.com/jquery.js"],
      ...
      function PostCode(codestring,endpoint) {
        ...
        console.log('posting to '+parsed.hostname+parsed.port+parsed.path);
