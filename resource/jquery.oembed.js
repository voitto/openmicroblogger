(function($) {
    $.fn.oembed = function(url, options, provider, pattern, apiurl) {		

		options = $.extend({}, $.fn.oembed.defaults, options);

    setOEmbedProvider(provider,pattern,apiurl);
    ...
    function setOEmbedProvider(name,url,apiurl) {
		  providers[providers.length++] = new OEmbedProvider(name,url,apiurl);
    }
